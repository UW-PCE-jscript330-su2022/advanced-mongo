...
describe("/movies routes", () => {
  ...
  describe("GET /:id/comments", () => {
    it("should return an array of movie comments on success", async () => {
      expect(false).toEqual(true);
    });
    it("should return a status code of 404 if movie not found", async () => {
      expect(false).toEqual(true);
   ...
   //Get a specified comment for a movie
  describe("GET /:movieId/comments/:commentId", () => {
    it("should return a comments for a movie on success", async () => {
      expect(false).toEqual(true);
    });
    it("should return a status code of 404 if movie not found", async () => {
      expect(false).toEqual(true);
